...
{*        <div class="col-xs-12 col-md nopadding input-group-lg translatable-input">*}
        <div class="col-xs-12 col-md-9 nopadding input-group-lg translatable-input">
            <textarea autocomplete="off" class="form-control" rows="3" id="{$input_name|escape:'htmlall':'UTF-8'}_{$language.id_lang|intval}" name="{$input_name|escape:'htmlall':'UTF-8'}_{$language.id_lang|intval}">{if isset($input_value) and isset($input_value[$language.id_lang])}{$input_value[$language.id_lang]|htmlentities|default:''}{/if}</textarea>
        </div>
                    ...
                    <li>
                        <a class="change-language" for="lang_{$flag_language.id_lang|intval}">
                            ...
                            {if $flag_language.id_lang eq $language.id_lang}
                                <i class="fa fa-flag-checkered nohover"></i>
                            {/if}
                        </a>
                    </li>
                {/foreach}
