...
$(document).ready( function() {
    ...
    if($('#lgcanonicalurls_force_http_https_off').prop('checked') == true) {
        ...
        $('input[name^="lgcanonicalurls_force_http_https_value"]:first').closest('div.margin-form').slideUp();
    }
    if($('#lgcanonicalurls_force_http_https_on').prop('checked') == true) {
        ...
        $('input[name^="lgcanonicalurls_force_http_https_value"]:first').closest('div.margin-form').slideDown();
    }
    ...
    $(document).on('click','#lgcanonicalurls_canonicalhome_off', function(){
        $('input[name^="lg_radiotext"]').prop('disabled', true);
        $('#lgcanonicalurls_canonicalhome_type_default').parent().fadeOut();
        $('#lgcanonicalurls_canonicalhome_type_default').parent().prev().fadeOut()
        $('input[name^="LGCANONICALURLS_CANHOME_TEXT"]:first').closest('div.margin-form').fadeOut();
        $('input[name^="LGCANONICALURLS_CANHOME_TEXT"]:first').closest('div.margin-form').prev().fadeOut();
    });
    $(document).on('click','#lgcanonicalurls_canonicalhome_on', function(){
        $('input[name^="lg_radiotext"]').prop('disabled', false);
        $('#lgcanonicalurls_canonicalhome_type_default').parent().fadeIn();
        $('#lgcanonicalurls_canonicalhome_type_default').parent().prev().fadeIn()
        $('input[name^="LGCANONICALURLS_CANHOME_TEXT"]:first').closest('div.margin-form').fadeIn();
        $('input[name^="LGCANONICALURLS_CANHOME_TEXT"]:first').closest('div.margin-form').prev().fadeIn();
    });
