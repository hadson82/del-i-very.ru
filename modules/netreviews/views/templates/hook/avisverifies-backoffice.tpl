	...
	<fieldset class="fieldsetav">
		...
		<div class='export'>
			...
			<form method="post" action="{$url_back|escape:'htmlall':'UTF-8'}" enctype="multipart/form-data">
				...
				<div class="floatleft">
					<div >
						<a class="text_decoration_none italic" href="javascript:cocheToute();">{l s='Check all' mod='netreviews'}</a>&nbsp;/&nbsp;<a class="text_decoration_none italic" href="javascript:decocheToute();">{l s='Uncheck all' mod='netreviews'}</a>
					</div>
					<br />
