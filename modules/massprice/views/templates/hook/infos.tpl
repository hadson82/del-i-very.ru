...
<div class="alert alert-message"> 
 ...
 <p>{l s='If you want to update combinations prices too, filter by manufacturers and attributes, please check MassPrice update plus: ' mod='masspriceplus'}<a href="http://catalogo-onlinersi.net/en/prices-and-promotions/424-mass-price-update-plus.html" target="_blank">MassPrice update plus</a></p><br/><br/>
