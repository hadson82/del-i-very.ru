...
class DocumentationSMT
{
    public static function assignDocumentation()
    {
        ...
        ToolsModuleSMT::addCSS('documentation.css');
        $documentation_folder = _PS_MODULE_DIR_.ToolsModuleSMT::getModNameForPath(__FILE__).'/views/templates/admin/documentation';
        $documentation_pages = ToolsModuleSMT::globRecursive($documentation_folder.'/**.tpl');
