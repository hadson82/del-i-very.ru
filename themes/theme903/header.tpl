...
<!--yandex-share-buttons-js-start-->
<script src="https://yastatic.net/es5-shims/0.0.2/es5-shims.min.js"></script>
<script src="https://yastatic.net/share2/share.js"></script>
<!--yandex-share-buttons-js-end->
		{$HOOK_HEADER}
	</head>
	...
	{if !$content_only}
		...
		<div class="page_wrapper_1 clearfix">
			...
			<header id="header" class="container">
				<div id="header_right">
				{if $page_name == 'index'}
                	<div id="header_logo" title="{$shop_name|escape:'htmlall':'UTF-8'}">
						<img class="logo" src="http://localhost/delivery/themes/theme903/img/logo.svg" data-png-fallback="http://localhost/delivery/themes/theme903/img/logo.png" alt="{$shop_name|escape:'htmlall':'UTF-8'}" width=351 height=80 />
                        <!--default code <img class="logo" src="/themes/theme903/img/logo.png" alt="{$shop_name|escape:'htmlall':'UTF-8'}" {if $logo_image_width} width="{$logo_image_width}"{/if} {if $logo_image_height} height="{$logo_image_height}"{/if}/>-->
                    </div>
					{else}
					...
					{/if}
					<!-- Телефон и почта вверху сайта -->
								<p id="header-phone" itemscope itemtype="https://schema.org/Organization"><a href="tel:+7(495)128-19-16" itemprop="telephone"><span class="glyphicon glyphicon-earphone" aria-hidden="true"></span> +7 (495) 128-19-16</a></p>
								<meta itemprop="name" content="Интернет-магазин ИКЕА del-i-very.ru">
								<meta itemprop="address" content="Москва, ул. Выборгская, д. 22, стр. 2">
								<p id="header-under-phone">Ежедневно с 10:00 до 22:00 МСК</p>
					<!-- Телефон и почта вверху сайта -->
					<!-- Надпись в логотипе -->
					{if $page_name == 'index'}
					<div id="logo-title"><p>Служба доставки ИКЕА</p></div>
					{else}
					<div id="logo-title"><a href="{$base_dir}" title="{$shop_name|escape:'htmlall':'UTF-8'}">Интернет-магазин ИКЕА</a></div>
					{/if}
					<!-- Надпись в логотипе -->
					{$HOOK_TOP}
				</div>
