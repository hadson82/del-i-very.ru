...
$_LANGMAIL['Your order has been changed'] = 'Заказ изменен';
$_LANGMAIL['Order confirmation'] = 'Ваш заказ принят в обработку - Интернет-магазин ИКЕА del-i-very.ru';
...
$_LANGMAIL['Email verification'] = 'Подтверждение email - del-i-very.ru';
...
$_LANGMAIL['New order : #%d - %s'] = 'Заказ del-i-very : #%d - %s';
