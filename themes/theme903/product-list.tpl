...
<li class="ajax_block_product col-xs-12 col-sm-6 col-md-4 col-lg-4 num-{$smarty.foreach.products.iteration}{if $smarty.foreach.products.iteration%$nbItemsPerLine == 0} omega{elseif $smarty.foreach.products.iteration%$nbItemsPerLine == 1} alpha{/if} {if $smarty.foreach.products.iteration > ($smarty.foreach.products.total - $totModulo)}last_line{/if} {if $smarty.foreach.products.iteration%$nbItemsPerLineTablet == 0}last_item_of_tablet_line{elseif $smarty.foreach.products.iteration%$nbItemsPerLineTablet == 1}first_item_of_tablet_line{/if} {if $smarty.foreach.products.iteration > ($smarty.foreach.products.total - $totModuloTablet)}last_tablet_line{/if}">
	<div class="inner_content clearfix" itemscope itemtype="https://schema.org/Product">
		...
		{if isset($product.reduction) && $product.reduction && isset($product.on_sale) && $product.on_sale && isset($product.show_price) && $product.show_price && !$PS_CATALOG_MODE}<div class="sale-box"><span class="before"></span><span class="after"></span><span class="on_sale title_shop">{l s='On sale!'}</span></div>{/if}
			...
			<div class="center_block">
				...
				<h5 itemprop="name">
					...
					<a itemprop="url" class="product_link" href="{$product.link|escape:'htmlall':'UTF-8'}" title="{$product.name|escape:'htmlall':'UTF-8'}">{$product.name|escape:'htmlall':'UTF-8'|truncate:150:'...'}</a>
				</h5>
				<p class="product_desc" itemprop="description">{$product.description_short|strip_tags:'UTF-8'|truncate:450:'...'}</p>
